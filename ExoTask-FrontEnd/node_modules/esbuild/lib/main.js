  ...
  if (/\.zip\//.test(binPath)) {
    ...
    if (pnpapi) {
      ...
      const binTargetPath = path.join(
        ...
        ".cache",
        "esbuild",
        `pnpapi-${pkg}-${"0.15.17"}-${path.basename(subpath)}`
      );
...
var _a;
var isInternalWorkerThread = ((_a = worker_threads == null ? void 0 : worker_threads.workerData) == null ? void 0 : _a.esbuildVersion) === "0.15.17";
...
var ensureServiceIsRunning = () => {
  ...
  let child = child_process.spawn(command, args.concat(`--service=${"0.15.17"}`, "--ping"), {
    windowsHide: true,
...
var runServiceSync = (callback) => {
  ...
  callback(service);
  let stdout = child_process.execFileSync(command, args.concat(`--service=${"0.15.17"}`), {
    cwd: defaultWD,
    windowsHide: true,
    input: stdin,
...
var startWorkerThreadService = (worker_threads2) => {
  ...
  let worker = new worker_threads2.Worker(__filename, {
    workerData: { workerPort, defaultWD, esbuildVersion: "0.15.17" },
