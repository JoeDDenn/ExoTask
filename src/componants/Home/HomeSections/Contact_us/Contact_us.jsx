                ...
                <div className="col-md-6 ">
                    <div className="contact-form">
                        <form >
                            ...
                            <div className="form-group">
                                <label>Subject</label>
                                <input type="text" className="form-control" required="required" placeholder='Subject'/>
                            </div>
                            <div className="form-group">
                                <label>Message</label>
                                <textarea className="form-control" rows="4" required="required" placeholder='Message'></textarea>
                            </div>
                            <div className="text-center"><button type="submit" className="btn  btn-contact_uss">Send Message</button></div>
                        </form>
                    </div>
                </div>
